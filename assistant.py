...
# Define Recognizer instance globally
...
if __name__ == "__main__":
    ...
    while True:
        ...
        elif "email to Mitra" in query:
            try:
                speak("What should I say?")
                content = takecommand()
                to = "Mitra@example.com"  # Replace with recipient's email address
                sendEmail(to, content)
                speak("Email has been sent to Mitra")
            except Exception as e:
                print(e)
                speak("Sorry sir, I am not able to send this mail to Mitra")
